...
fn get_env_var_for_provider(id: &str) -> &'static str {
    match id {
        ...
        "kimi-for-coding" | "kimi-code" => "KIMI_FOR_CODING_API_KEY",
...
fn get_url_for_provider(id: &str) -> &'static str {
    match id {
        ...
        "kimi-for-coding" | "kimi-code" => "kimi.com/code",
...
fn provider_picker_items() -> Vec<SelectItem> {
    vec![
        ...
        SelectItem { id: "kimi-for-coding".into(), title: "Kimi For Coding".into(), description: "Kimi Code dedicated endpoint".into(), category: "Popular".into(), badge: None },
